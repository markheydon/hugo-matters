...
using HugoMatters.ThemePacks.Models;

namespace HugoMatters.ThemePacks.Packs;
...
public static class HugoProfileThemePack
{
    ...
    public const string EmbeddedResourceName = "HugoMatters.ThemePacks.Packs.hugo-profile.json";
